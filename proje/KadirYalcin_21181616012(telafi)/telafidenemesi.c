...
int main() {
	...
	char film[20][7][200]={{},{"\0","Inception","Cristopher_NOLAN","Leonardo_DICAPRIO","Cillian_MURPHY","Ingilizce","Hayir"},{"\0","Interstaller","Cristopher_NOLAN","Matthew_MCCONAUGHEY","Anne_HATHAWAY","Ingilizce","Evet"},{"\0","Joker","Todd_PHILLIPS","Joaquin_PHOENIX","Zazie_BEETZ","Ingilizce","Evet"},{"\0","Seraparation","Asgar_FERHADI","Leyla_HATEMI","Sahab_HUSEYNI","Farsca","Hayir"},{"\0","Mad_Max","George_MILLER","Tom_HARDY","Zoe_KRAVITZ","Ingilizce","Hayir"},{"\0","Room","Lenny_ABRAHAMSON","brie_LARSON","Jacob_TREMBRLY","Ingilizce","Hayir"},{"\0","Spotlight","Tom_MCCARTHY","Mark_RUFFALO","John_SLATTERY","Ingilizce","Evet"},{"\0","Black_Swan","Darren_ARONOFSKY","Natalie_PORTMAN","Mila_KUNIS","Ingilizce","Evet"}};
	char gecici[20][7][200];																//Filmler dizisinde daha kolay islem yapabilmek icin sifirinci degerlerini bos biraktim.
	char e;
	int i=9,b,c,k,l,z;
